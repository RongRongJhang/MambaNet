...
def main():
    ...
    weights_path = '/content/drive/MyDrive/Mamba-Net/best_model.pth'
    ...
    result_dir = '/content/drive/MyDrive/Mamba-Net/results/testing/output'
    ...
    file_path = "/content/drive/MyDrive/Mamba-Net/results/testing/metrics.md"
