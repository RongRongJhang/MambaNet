...
def main():
    ...
    result_dir = '/content/drive/MyDrive/Mamba-Net/results/training/output'
    ...
    for epoch in range(num_epochs):
        ...
        if avg_psnr > best_psnr:
            best_psnr = avg_psnr
            model_path = "/content/drive/MyDrive/Mamba-Net/best_psnr_model.pth"
        ...
        if avg_ssim > best_ssim:
            best_ssim = avg_ssim
            model_path = "/content/drive/MyDrive/Mamba-Net/best_ssim_model.pth"
            torch.save(model.state_dict(), model_path)
        ...
        if avg_lpips < best_lpips:
            ...
            model_path = "/content/drive/MyDrive/Mamba-Net/best_lpips_model.pth"
            torch.save(model.state_dict(), model_path)
            print(f'Saving model with LPIPS: {best_lpips:.6f}')
        
        # write log
        now = datetime.now().strftime("%Y-%m-%d-%H%M%S")
        file_path = "/content/drive/MyDrive/Mamba-Net/results/training/metrics.md"
